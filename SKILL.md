...
> In a one-factor generalized linear mixed model (Poisson distribution), the number of offspring was significantly affected by the temperature main effect (*χ*²(₃) = 15.20, *P* = 0.002). At temperature 30 ℃ the number of offspring was 4.50 ± 0.30 (marginal mean), not significantly different from temperature 15 ℃ (4.20 ± 0.25) (*P* = 0.85, pairwise comparison); but at temperature 25 ℃ (8.20 ± 0.40) it increased by 4.00 relative to temperature 15 ℃ (+95.24%, *P* < 0.001, pairwise comparison), and increased by 3.70 relative to temperature 30 ℃ (+82.22%, *P* < 0.001, pairwise comparison). Overall it shows a rise-then-fall unimodal trend. This main effect can be independently interpreted.
