...
> 三因素线性模型中，若虫体面积受发育温度（*F*₁,₄₄₅ = 48.55, *P* < 0.001）主效应的显著影响，所有交互项均不显著（所有 *P* > 0.05）。27 ℃ 发育个体若虫体面积为 0.62 mm²（边际均值），较 22 ℃ 发育（0.38 mm²）升高 0.24 mm²（+63.16%, *P* < 0.001, 两两比较）。各主效应可独立解释（所有交互均不显著）。
